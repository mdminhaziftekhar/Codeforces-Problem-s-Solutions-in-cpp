...
int main() {
    ...
    if(c == 0){
            ...
            cout << zero.size()+(odd.size()-k) << " ";
            fr(i, 0, zero.size()) cout << zero[i] << " ";
            if(odd.size()-k > 0)fr(i, k, odd.size()) cout << odd[i] << " ";
            cout << endl;
    }
    else{
        ...
        cout << (odd.size()-c) + even.size() << " ";
        if(odd.size()-c > 0) fr(i, c, odd.size()) cout << odd[i] << " ";
